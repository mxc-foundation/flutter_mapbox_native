...
@implementation MapboxJsonConversions
...
+ (CLLocationCoordinate2D)toLocation:(NSArray*)data {
  return CLLocationCoordinate2DMake([MapboxJsonConversions toDouble:data[0]],
                                [MapboxJsonConversions toDouble:data[1]]);
}

// + (CGPoint)toPoint:(NSArray*)data {
//   return CGPointMake([MapboxJsonConversions toDouble:data[0]],
//                      [MapboxJsonConversions toDouble:data[1]]);
// }

// + (NSArray*)positionToJson:(CLLocationCoordinate2DMake)position {
...
//     CLLocation* point =
//         [[CLLocation alloc] initWithLatitude:[MapboxJsonConversions toDouble:latitude]
//                                    longitude:[MapboxJsonConversions toDouble:longitude]];
